...
class ITooJpeg {
 public:
  ITooJpeg() {}
  virtual ~ITooJpeg() {}
  virtual bool writeJpeg(const void* pixels, unsigned short width, unsigned short height,
                 unsigned char quality = 90, const char* comment = nullptr);
};

ITooJpeg* getTooJpeg(WRITE_ONE_BYTE output);
