...
#define MEMP_NUM_TCP_SEG            24 // was 16
...
#define TCP_SND_QUEUELEN            ((4 * (TCP_SND_BUF) + (TCP_MSS - 1)) / (TCP_MSS))  // Was ((2 * (TCP_SND_BUF) + (TCP_MSS - 1)) / (TCP_MSS))
...
#define LWIP_NETIF_TX_SINGLE_PBUF   0 // Was 1
...
// #define PBUFF_POOL_SIZE             4
// #define MEMP_NUM_PBUF               8
#endif /* __LWIPOPTS_H__ */

// Reduce wait time for ACK (default is like 250)
